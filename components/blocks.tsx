      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Ethereum Contract Tracker turned data into actionable insights for our team, allowing us to make strategic decisions backed by real-time blockchain intelligence.</h2>
